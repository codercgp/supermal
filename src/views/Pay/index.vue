  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <a class="btn" @click="goPaysuccess">立即支付</a>
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
...
export default {
  ...
  mounted () {
    this.$API.reqPayInfo(this.$route.query.orderId).then((res) => {
      console.log(res)
      if (res.code == 200) {
    ...
    goPaysuccess () {
      QRCode.toDataURL(this.payInfo.codeUrl).then((url) => {
        ...
        this.$alert(`<img src=${url} />`, '请你微信支付', {
          ...
          confirmButtonText: '已支付', // 点击确定按钮的内容
          cancelButtonText: '支付遇到问题', // 点击取消按钮的内容
          showCancelButton: true,
          showClose: false,
          beforeClose: (action, instance, done) => {
            if (action == 'cancel') {
              this.$message.error('把小胖卖了就有钱了')
              // 关闭定时器
